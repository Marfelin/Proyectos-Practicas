...
public class ReportGeneratorProductos {
    ...
    public void generarReporteProductos(@RequestParam String usuarioid, @RequestParam String categoria, @RequestParam String subcategoria, HttpServletResponse response) throws Exception {
