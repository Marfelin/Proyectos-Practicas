...
@RestController
public class ReportGeneratorProductos {

    @GetMapping("/GenerarReporteProductos")
    public void generarReporteProductos(@RequestParam String id,@RequestParam String usuarioid, @RequestParam String categoria, @RequestParam String subcategoria, HttpServletResponse response) throws Exception {
        Connection conn = DatabaseConnection.getConnection();

        InputStream reportStream = getClass().getResourceAsStream("/ReporteProductos.jasper");
