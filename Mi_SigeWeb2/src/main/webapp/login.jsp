...
<%
    ...
    try {
        ...
        String query = "SELECT u.id, t.nombre AS tipo FROM usuario u JOIN tipo t ON u.tipoid = t.id WHERE u.nombreusuario = ? AND u.contrase�a = ?";
        ...
        if (rs.next()) {
            ...
            httpSession.setAttribute("logeado", "1"); // Corregir el error tipogr�fico
