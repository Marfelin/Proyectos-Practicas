            ...
            <div class="row">
                    ...
                    <ul class="nav flex-column">
                        ...
                        <li class="nav-item">
                            ...
                            <ul class="nav flex-column ml-3">
                                ...
                                <li class="nav-item">
                                    <a class="nav-link" href="#" onclick="showContainer('bajaTecnicas')">Baja Técnicas</a>
                ...
                <main class="col-md-10 mt-5">
                    <div id="mainContent">
                        ...
                        <p>Esta es la página de mantenimiento.</p>
                    </div>
                    <!-- Contenedor para Útiles y Herramientas -->
                    ...
                    <div id="bajaTecnica" class="container-content">
                        ...
                        <hr>
                        <button class="btn btn-primary" onclick="bajasTecnicasMantenimiento()">Baja Técnica</button>
                    </div>
                </main>
            </div>
        </div>
